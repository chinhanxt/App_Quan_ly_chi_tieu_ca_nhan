...
class AppIcons {
  ...
  IconData getIconData(String iconName) {
    ...
    final category = [...suggestedCategories, ...defaultCategories]
        .cast<Map<String, dynamic>>()
        .firstWhere(
          (c) => c['iconName'] == normalized || c['name'] == normalized,
          orElse: () => {"icon": FontAwesomeIcons.cartShopping},
        );
    return category['icon'] as IconData;
  }

  String getIconNameFromIcon(IconData icon) {
    final category = [...suggestedCategories, ...defaultCategories]
        .cast<Map<String, dynamic>>()
        .firstWhere(
          (c) => c['icon'] == icon,
          orElse: () => {"iconName": "cartShopping"},
        );
    return category['iconName'] as String;
  }
